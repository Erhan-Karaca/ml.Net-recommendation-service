...
namespace MovieRecommenderML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\xampp\htdocs\myserver\MovieRecommender\MovieRecommender\Data\recommendation-ratings-test.csv";
        private static string MODEL_FILEPATH = @"C:\Users\Erhan\AppData\Local\Temp\MLVSTools\MovieRecommenderML\MovieRecommenderML.Model\MLModel.zip";
        ...
        public static void CreateModel()
        {
            ...
            else
            {
                ...
                List<ModelInput> list = mysql.GetMovieList();
                IEnumerable<ModelInput> test = list.AsEnumerable<ModelInput>();
                trainingDataView = mlContext.Data.LoadFromEnumerable(test);
            }
            ...
            Evaluate(mlContext, trainingDataView, trainingPipeline, mlModel);
        ...
        private static void Evaluate(MLContext mlContext, IDataView trainingDataView, IEstimator<ITransformer> trainingPipeline, ITransformer mlModel)
        {
            var prediction = mlModel.Transform(trainingDataView);
